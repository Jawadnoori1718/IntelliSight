...
class CameraStage(QFrame):
    ...
    def _build_idle(self) -> QWidget:
        ...
        lay.addWidget(self._center(QLabel("Point the camera at anything"), "StageTitle"))
        lay.addWidget(self._center(QLabel("IntelliSight will box and name what it's sure about."), "StageHint"))
        lay.addSpacing(16)
