...
class CameraStage(QFrame):
    ...
    def _build_idle(self) -> QWidget:
        ...
        lay.addSpacing(18)
        lay.addWidget(self._center(QLabel("IntelliSight"), "StartTitle"))
        lay.addWidget(self._center(QLabel("Point your camera at anything — it names what it sees."), "StartHint"))
        lay.addSpacing(24)
    ...
    def _build_overlays(self) -> None:
        ...
        brow.addWidget(self._plain(QLabel("IntelliSight"), "BrandName"))
